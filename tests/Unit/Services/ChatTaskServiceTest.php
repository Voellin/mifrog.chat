...
class ChatTaskServiceTest extends TestCase
{
                ...
                'data' => [
                    'messages' => [
                        [
                            ...
                            'chat_type' => 'group',
                            'sender_name' => '用户A',
                            'content' => '用户A手机号 13800138000 邮箱 test@example.com https://example.com 周报',
    ...
    public function testReadHistoryFindsCommunicationWithNamedParticipantAcrossSharedChats(): void
    {
        ...
        $this->assertStringContainsString('you and 用户B across 1 chat', $result['message']);
    ...
    {
        $this->assertSame(['contact', '+search-user', '--query', '用户B'], $command);

        return [
            'code' => 0,
            'data' => [
                'users' => [
                    ['name' => '用户B', 'open_id' => 'ou_zhuque'],
                ],
            ],
        ];
    }
